<%-- 
    ...
    Created on : Mar 16, 2018, 2:04:44 PM
    Author     : Sahil Bharti
--%>
...
<html>
    ...
    <body>
        ...
        %>
        <div class ="newSearch">
            <a href="SearchPage.jsp"><img class = "newlogo" src="images/SmallSearchEngine.png" alt="Search Logo"></a>
            <form action ="dispRows" method = "POST">
               <!--   <input type="text" name ="keyword" class = "newsearchbox"> original line. below line is my editing-->
                <input type="text" name ="title" class = "newsearchbox">
