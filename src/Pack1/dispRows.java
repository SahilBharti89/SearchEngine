...
public class dispRows extends HttpServlet {
    ...
    //public String keyword = ""; original title
    public String title = ""; 	//duplicate title
    ...
    private void process(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String DB_URL = "jdbc:mysql://localhost:3306/Sahil_works";
        ...
        try {
            ...
            String sql;
            sql = "SELECT URL,Title FROM crawler_db where title like '%" + title + "%' order by title;";
            //sql = "select URL,Title from crawler_db where match(Title) against('" + keyword + "')"; original sql 
            //sql = "select URL,Title from crawler_db where Title='" + keyword + "'";
            //sql = "select URL,Title from crawler_db where Title='" + title + "'";
